...
enum opt_code
{
  ...
  OPT_fhonour_copts = 1203,                  /* -fhonour-copts */
  ...
  OPT_frevert_dip1000 = 1481,                /* -frevert=dip1000 */
  ...
  OPT_list = 1767,                           /* -list */
  OPT_mabi_ = 1768,                          /* -mabi= */
  OPT_mabicalls = 1769,                      /* -mabicalls */
  OPT_mabs_ = 1770,                          /* -mabs= */
  OPT_mandroid = 1771,                       /* -mandroid */
  OPT_march_ = 1772,                         /* -march= */
  OPT_mbionic = 1773,                        /* -mbionic */
  OPT_mbranch_cost_ = 1774,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1775,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1776,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1777,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1778,             /* -mcompact-branches= */
  OPT_mcrc = 1779,                           /* -mcrc */
  OPT_mdebug = 1780,                         /* -mdebug */
  OPT_mdebugd = 1781,                        /* -mdebugd */
  OPT_mdivide_breaks = 1782,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1783,                  /* -mdivide-traps */
  OPT_mdmx = 1784,                           /* -mdmx */
  OPT_mdouble_float = 1785,                  /* -mdouble-float */
  OPT_mdsp = 1786,                           /* -mdsp */
  OPT_mdspr2 = 1787,                         /* -mdspr2 */
  OPT_meb = 1788,                            /* -meb */
  OPT_mel = 1789,                            /* -mel */
  OPT_membedded_data = 1790,                 /* -membedded-data */
  OPT_meva = 1791,                           /* -meva */
  OPT_mexplicit_relocs = 1792,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1793,                  /* -mextern-sdata */
  OPT_mfix_24k = 1794,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1795,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1796,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1797,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1798,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1799,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1800,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1801,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1802,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1803,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1804,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1805,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1806,                 /* -mfp-exceptions */
  OPT_mfp32 = 1807,                          /* -mfp32 */
  OPT_mfp64 = 1808,                          /* -mfp64 */
  OPT_mfpxx = 1809,                          /* -mfpxx */
  OPT_mframe_header_opt = 1810,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1811, */              /* -mfused-madd */
  OPT_mginv = 1812,                          /* -mginv */
  OPT_mglibc = 1813,                         /* -mglibc */
  OPT_mgp32 = 1814,                          /* -mgp32 */
  OPT_mgp64 = 1815,                          /* -mgp64 */
  OPT_mgpopt = 1816,                         /* -mgpopt */
  OPT_mhard_float = 1817,                    /* -mhard-float */
  OPT_mimadd = 1818,                         /* -mimadd */
  OPT_minterlink_compressed = 1819,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1820,              /* -minterlink-mips16 */
  OPT_mips = 1821,                           /* -mips */
  OPT_mips16 = 1822,                         /* -mips16 */
  OPT_mips3d = 1823,                         /* -mips3d */
  OPT_mllsc = 1824,                          /* -mllsc */
  OPT_mload_store_pairs = 1825,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1826,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1827,                    /* -mlong-calls */
  OPT_mlong32 = 1828,                        /* -mlong32 */
  OPT_mlong64 = 1829,                        /* -mlong64 */
  OPT_mloongson_ext = 1830,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1831,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1832,                  /* -mloongson-mmi */
  OPT_mlra = 1833,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1834,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1835,                           /* -mmad */
  OPT_mmadd4 = 1836,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1837,             /* -mmcount-ra-address */
  OPT_mmcu = 1838,                           /* -mmcu */
  OPT_mmemcpy = 1839,                        /* -mmemcpy */
  OPT_mmicromips = 1840,                     /* -mmicromips */
  OPT_mmsa = 1841,                           /* -mmsa */
  OPT_mmt = 1842,                            /* -mmt */
  OPT_mmusl = 1843,                          /* -mmusl */
  OPT_mnan_ = 1844,                          /* -mnan= */
